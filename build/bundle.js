...
module.exports = Handlebars.template({"compiler":[5,">= 2.0.0"],"main":function(depth0,helpers,partials,data) {
  ...
  return "<div class=\"leftSide\">\n<form class=\"mmmInputForm\">\n  <h1>mean, median, and mode</h1>\n  <h2>...with Backbone!</h2>\n  <p>Input your numbers as comma separated values and no spaces.</p>\n  <p>Example: 1,1999,5,5,18,0,16,404,16</p>\n  <input type=\"textarea\" name=\"mmmInputField\" placeholder=\"Enter numbers here\"></input><br>\n  <button>Calculate!</button>\n</form>\n</div>\n\n<div class=\"rightSide\">\n  <div class=\"mmmResult\">\n  <ul>\n    <li><h2>mean</h2><div id=\"meanresult\">"
    + escapeExpression(((helper = helpers.mean || (depth0 && depth0.mean)),(typeof helper === functionType ? helper.call(depth0, {"name":"mean","hash":{},"data":data}) : helper)))
    + "</div></li>\n    <li><h2>median</h2><div id=\"medianresult\">"
    + escapeExpression(((helper = helpers.median || (depth0 && depth0.median)),(typeof helper === functionType ? helper.call(depth0, {"name":"median","hash":{},"data":data}) : helper)))
    + "</div></li>\n    <li><h2>mode</h2><div id=\"moderesult\">"
